...
public class BeanUtil extends org.springframework.beans.BeanUtils {
	 ...
	 * @param beanMap      map
	 * @param valueType    对象类型
	 * @param useConverter 是否使用EnhancedConvert (拷贝对象并对不同类型属性进行转换)
	 * @param <T>          泛型标记
	 * @return {T}
	 */
	public static <T> T toBean(Map<String, Object> beanMap, Class<T> valueType, Boolean useConverter) {
		...
		if (useConverter) {
			return BeanUtil.copyWithConvert(beanMap, valueType);
		}
