package com.oceancloud.grampus.framework.core.utils.crypto;

import com.google.common.base.Charsets;
import com.oceancloud.grampus.framework.core.utils.Exceptions;
import com.oceancloud.grampus.framework.core.utils.RandomUtil;
import com.oceancloud.grampus.framework.core.utils.StringUtil;
import com.oceancloud.grampus.framework.core.utils.encode.Base64Util;
import com.oceancloud.grampus.framework.core.utils.encode.HexUtil;
...
public class DESUtil {
	...
	private static byte[] des(byte[] data, byte[] desKey, int mode) {
		try {
			...
			cipher.init(mode, keyFactory.generateSecret(desKeySpec), RandomUtil.SECURE_RANDOM);
