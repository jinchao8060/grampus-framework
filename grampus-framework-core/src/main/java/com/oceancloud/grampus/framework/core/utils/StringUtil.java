...
public class StringUtil extends StringUtils {
	...
	public static String format(@Nullable String message, @Nullable Map<String, ?> params) {
		...
		int cursor = 0;
		for (int start, end; (start = message.indexOf(StringPool.DOLLAR + StringPool.LEFT_BRACE, cursor)) != -1 && (end = message.indexOf(StringPool.RIGHT_BRACE, start)) != -1; ) {
	...
	public static String rightPad(@Nullable final String str, final int size) {
		return rightPad(str, size, StringPool.SPACE);
	}
	...
	public static String leftPad(@Nullable final String str, final int size) {
		return leftPad(str, size, StringPool.SPACE);
	}
