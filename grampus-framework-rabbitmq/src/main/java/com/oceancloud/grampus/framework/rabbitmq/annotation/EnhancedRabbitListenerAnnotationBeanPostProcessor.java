...
import com.oceancloud.grampus.framework.rabbitmq.listener.EnhancedMethodRabbitListenerEndpoint;
import com.oceancloud.grampus.framework.rabbitmq.listener.EnhancedMultiMethodRabbitListenerEndpoint;
 ...
 */
public class EnhancedRabbitListenerAnnotationBeanPostProcessor
	...
	public EnhancedRabbitListenerAnnotationBeanPostProcessor() {
	...
	private void processMultiMethodListeners(RabbitListener[] classLevelListeners, Method[] multiMethods,
		...
		for (RabbitListener classLevelListener : classLevelListeners) {
			EnhancedMultiMethodRabbitListenerEndpoint endpoint =
					new EnhancedMultiMethodRabbitListenerEndpoint(checkedMethods, defaultMethod, bean);
	...
	protected Collection<Declarable> processAmqpListener(RabbitListener rabbitListener, Method method, Object bean,
		...
		EnhancedMethodRabbitListenerEndpoint endpoint = new EnhancedMethodRabbitListenerEndpoint();
	...
	protected Collection<Declarable> processListener(EnhancedMethodRabbitListenerEndpoint endpoint,
	...
	private void resolveErrorHandler(EnhancedMethodRabbitListenerEndpoint endpoint, RabbitListener rabbitListener) {
	...
	private void resolveAckMode(EnhancedMethodRabbitListenerEndpoint endpoint, RabbitListener rabbitListener) {
	...
	private void resolveAdmin(EnhancedMethodRabbitListenerEndpoint endpoint, RabbitListener rabbitListener, Object adminTarget) {
	...
	private void resolveExecutor(EnhancedMethodRabbitListenerEndpoint endpoint, RabbitListener rabbitListener,
	...
	private void resolvePostProcessor(EnhancedMethodRabbitListenerEndpoint endpoint, RabbitListener rabbitListener,
	...
	private void resolveMessageConverter(EnhancedMethodRabbitListenerEndpoint endpoint, RabbitListener rabbitListener,
										 Object target, String beanName) {
	...
	private void resolveReplyContentType(EnhancedMethodRabbitListenerEndpoint endpoint, RabbitListener rabbitListener) {
	...
	private class RabbitHandlerMethodFactoryAdapter implements MessageHandlerMethodFactory {
		...
		private MessageHandlerMethodFactory createDefaultMessageHandlerMethodFactory() {
			...
			Validator validator = EnhancedRabbitListenerAnnotationBeanPostProcessor.this.registrar.getValidator();
			if (validator != null) {
				defaultFactory.setValidator(validator);
			}
			defaultFactory.setBeanFactory(EnhancedRabbitListenerAnnotationBeanPostProcessor.this.beanFactory);
			DefaultConversionService conversionService = new DefaultConversionService();
			conversionService.addConverter(
					new BytesToStringConverter(EnhancedRabbitListenerAnnotationBeanPostProcessor.this.charset));
			defaultFactory.setConversionService(conversionService);

			List<HandlerMethodArgumentResolver> customArgumentsResolver =
					new ArrayList<>(EnhancedRabbitListenerAnnotationBeanPostProcessor.this.registrar.getCustomMethodArgumentResolvers());
